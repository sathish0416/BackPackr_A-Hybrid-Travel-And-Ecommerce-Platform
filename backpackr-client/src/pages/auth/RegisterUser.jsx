...
// Footer copied from Home/RoleSelection
const Footer = () => (
...
const RegisterUser = () => {
  ...
  const getInputClasses = (fieldName) => {
    const baseClasses = "appearance-none relative block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Check if there's a specific redirect path in the result
      ...
      setError('Unable to create your account. Please check your internet connection and try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="relative flex-grow h-screen">
        <div className="w-full h-screen overflow-hidden relative">
          ...
          {/* Left-side marketing copy, similar to RoleSelection */}
          <div className="absolute inset-0 hidden md:flex flex-col justify-end pl-10 pb-10 text-left max-w-md">
            ...
            <h1 className="text-3xl lg:text-4xl font-extrabold text-white mb-3">
              Start your story with Backpackr.
            </h1>
            <p className="text-sm text-gray-200">
              Create your traveler account to discover curated trips, smart packing ideas, and
              gear picks made for real-world adventures.
            </p>
          </div>
            ...
            <div className="w-full max-w-md bg-white/90 border border-gray-100 shadow-xl rounded-2xl p-8 md:p-10">
              <div className="space-y-6">
                  ...
                  <div className="rounded-md shadow-sm space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className={getInputClasses('name') + " rounded-t-md"}
                    ...
                    <div>
                      ...
                      <div className="relative rounded-md shadow-sm">
                        <input
                          ...
                          onChange={handleChange}
                          className={getInputClasses('confirmPassword') + " rounded-b-md pr-10"}
                ...
                <div className="mt-4 text-center text-sm text-gray-600">
                  ...
                  <Link to="/auth/login/user" className="font-medium text-blue-600 hover:text-blue-500">
                    Sign in
                  </Link>
                </div>
