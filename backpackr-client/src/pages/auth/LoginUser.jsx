...
const LoginUser = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && user?.role === 'user') {
      navigate('/home');
    } else if (isAuthenticated && user?.role === 'agency') {
      // If agency user is on user login page, redirect to agency login
  ...
  const handleGoogleSignIn = async () => {
    try {
      const response = await fetch('http://localhost:5000/api/auth/google?userType=user');
        ...
        <div className="w-full h-screen overflow-hidden relative">
          ...
          <div className="absolute inset-0 hidden md:flex flex-col justify-end pl-10 pb-10 text-left max-w-md">
            ...
            <p className="text-sm text-gray-200">
              Sign in to pick up where you left off, revisit saved itineraries, and keep your
            ...
            <div className="w-full max-w-md bg-white/90 border border-gray-100 shadow-xl rounded-2xl p-8 md:p-10">
              <div className="space-y-6">
                <div className="text-center">
                  <h2 className="text-3xl font-bold text-gray-900">Traveler Sign In</h2>
                </div>
                ...
                <div className="mt-4 text-center text-sm text-gray-600">
                  ...
                  <Link to="/auth/register/user" className="font-medium text-blue-600 hover:text-blue-500">
                    Sign up
                  </Link>
                </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-3 bg-blue-50 text-blue-700 rounded-full font-medium">Or continue with</span>
                    </div>
                  </div>
